...
def disp_loginpage():
    ...
    print(app) # prints <Flask 'app'> in the terminal
    print("***DIAG: request obj ***")
    print(request) # <Request 'http://127.0.0.1:5000/auth?username=&sub1=Submit' [GET]>
    print("***DIAG: request.args ***")
    print(request.args) # ImmutableMultiDict([('username', ''), ('sub1', 'Submit')])
